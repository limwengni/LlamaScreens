<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminError405.aspx.cs" Inherits="LlamaScreens.Admin.AdminError405" %>
            ...
            <div class="container-fluid" style="padding-bottom: 200px;">
                <div class="row justify-content-center" title="Joy + Smile = Happy">
                    ...
                    <span class="row text-white d-flex justify-content-center" style="opacity: 0.8;">
                        <span class="row justify-content-center" style="font-weight: 600;">Error Page
                        </span>
                ...
                <div class="row"
                    ...
                    <div class="row justify-content-center"
                        ...
                        <h5 class="errorMsg"><span>405</span><br/>Method Not Allowed</h5>

                        <div class="row" style="margin: 0 auto;">
                            <div class="row" style="margin: 0 auto; padding: 0;">
                                <asp:Label ID="lblvalid" runat="server" class="validmsg">Sorry, your requested method is not allowed for this page</asp:Label>
                            </div>

                            <div class="row" style="margin: 0 auto;">
                                <div class="btn-wrap">
                                     <asp:Button runat="server" ID="okBtn" CssClass="loginbtn" Text="Ok" OnClick="okBtn_Click"/>
                                </div>
                            </div>
                        </div>
                    </div>
