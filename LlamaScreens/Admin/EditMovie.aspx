<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainAdmin.Master" AutoEventWireup="True" CodeBehind="EditMovie.aspx.cs" Inherits="LlamaScreens.Admin.EditMovie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div style="display: flex; flex-direction: column; flex-grow: 1; position: relative;">
                    ...
                    <div class="input-container flex-column">
                        <div class="input-wrap">
                            <asp:TextBox ID="titleInput" CssClass="inputbox down" runat="server"
                                placeholder="Movie title" Required="true" title="Fill In Movie Title"></asp:TextBox>
                            <label for="titleInput">Title</label>
                        </div>
                        <div class="input-wrap">
                            <asp:TextBox ID="descriptionInput" CssClass="inputbox down" runat="server"
                                Rows="6" Columns="100" TextMode="MultiLine" placeholder="Desc" Required="true"
                                title="Fill In Movie Description"></asp:TextBox>
                    ...
                    <div class="input-container-row" style="gap: 0 20px; max-width: 500px;">
                        <div class="input-wrap small-wrap">
                            <asp:TextBox ID="lengthInput" CssClass="inputbox smallInput down" runat="server"
                                type="number" placeholder="In Minutes" Required="true" title="Fill In Movie Length In Minutes"
                                min="1" max="9999"></asp:TextBox>
                            <label for="lengthInput">Movie Length</label>
                        </div>
                        <div class="input-wrap small-wrap">
                            <asp:TextBox ID="date" CssClass="inputbox dateInput smallInput down" runat="server"
                                type="date" Required="true"
                                title="Fill In Movie Release Date"></asp:TextBox>
                            <label for="date">Release Date</label>
                        </div>
                        <div class="input-wrap">
                            <asp:TextBox ID="directorInput" CssClass="inputbox down" runat="server"
                                type="text" placeholder="Directors" Required="true" title="Fill In Movie Directors"></asp:TextBox>
                            <label for="directorInput">Directors</label>
                        </div>
                        <div class="input-wrap small-wrap">
                            <asp:TextBox ID="companyInput" CssClass="inputbox smallInput down" runat="server"
                                type="text" placeholder="Company" Required="true"
                                title="Fill In Movie Company"></asp:TextBox>
                            <label for="companyInput">Company</label>
                        </div>
                        <div class="input-wrap small-wrap">
                            <asp:TextBox ID="countryInput" CssClass="inputbox smallInput down" runat="server"
                                type="text" placeholder="Country" Required="true"
                                title="Fill In Movie Country"></asp:TextBox>
                            <label for="countryInput">Country</label>
                        </div>
                        <div class="input-wrap">
                            <asp:TextBox ID="actorInput" CssClass="inputbox down" runat="server"
                                type="text" placeholder="Actors" Required="true" title="Fill In Movie Actors"></asp:TextBox>
                            ...
                            <div class="categorybox down">
                                ...
                                <div class="selectedCategory down"
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" Class="selectedCategoryBox">
                                        <ContentTemplate>
                                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:Llamadb %>"></asp:SqlDataSource>
                                            <asp:Repeater ID="Repeater2" runat="server" DataSourceID="SqlDataSource1" OnItemDataBound="Repeater_ItemDataBound">
                                                <ItemTemplate>
                                ...
                                <div class="searchCategory down"
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" Class="availableCategoryBox tablecover">
                                        <ContentTemplate>
                                            <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:Llamadb %>" SelectCommand="SELECT * FROM [Category]"></asp:SqlDataSource>
                                            <asp:Repeater ID="Repeater3" runat="server" DataSourceID="SqlDataSource2" OnItemDataBound="Repeater_ItemDataBound">
                                                <ItemTemplate>
        ...
        <div class="confirm-btn-wrap">
            <asp:Button runat="server" ID="confirmBtn" class="btn up hover-moreup" Text="Confirm" OnClick="Form_Submission"
                Style="font-size: 0.8em;"></asp:Button>
        </div>
    </div>
</asp:Content>
