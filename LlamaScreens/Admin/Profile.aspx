<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainAdmin.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="LlamaScreens.Admin.Profile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .input-container-wrap > .admin-detail-content-wrap-inner {
            padding: 0 10px;
            gap: 10px;
        }
    </style>
            ...
            <div style="display: flex; flex-direction: column; flex-grow: 1; position: relative; padding: 0;">
                <div class="main-content-wrap up">
                    <div class="left-content-wrap">
                        <p class="right-content-title">Details</p>
                        <div class="admin-detail-wrap input-container-wrap down">
                            <div class="admin-detail-content-wrap-inner">
                                <div class="admin-detail-content-wrap">
                                    <div class="admin-detail-label">Admin Name</div>
                            ...
                            <div class="edit-btn-wrap">
                                <button class="btn up hover-moreup active-down" type="button" onclick="location.href='../AdminChangePassword.aspx'">Change Password</button>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="adminlog-text-wrap">
                                                        <div class="admin-detail-content-wrap-inner">
                                                            <div class="admin-detail-content-wrap">
                                                                ...
                                                                <div class="admin-detail-content"><%# Eval("created_date","{0:dd MM yyyy}") %></div>
                                                            </div>
                                                            <div class="admin-detail-content-wrap">
