<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="WebAssignment.AdminLogin" %>
        ...
        <form id="form1" runat="server" class="d-flex h-100 justify-content-center bg">
            <div class="d-flex align-items-center" style="z-index: 1;">
                <div class="container-fluid" style="padding-bottom: 200px;">
                    <div class="row justify-content-center" title="Joy + Smile = Happy">
                        ...
                        <span class="row text-white d-flex justify-content-center" style="opacity: 0.8;">
                            <span class="row justify-content-center" style="font-weight: 600;">
                                Welcome Back,
                            </span>
                            ...
                            <div class="row" style="margin: 0 auto;">
                                <div class="row" style="margin: 0 auto;">
                                    <asp:Label ID="lblpassword" runat="server" Text="Password"
                                        AssociatedControlID="textboxpassword" class="label"></asp:Label>
                                </div>
                                <div class="row" style="margin: 0 auto;">
                                    <asp:TextBox ID="textboxpassword" runat="server" placeholder="*************"
                                        class="textbox" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row" style="margin: 0 auto;">
                                <div class="row" style="margin: 0 auto;">
                                    <asp:CheckBox ID="rememberme" runat="server" Text="Remember me" class="checkbox" />
                                </div>
                                
                                <div class="row" style="margin: 0 auto; padding: 0;">
                                    <asp:Label ID="lblvalid" runat="server" class="validmsg">
                                        <b style="opacity: 0.6; font-weight: 500;">
                                ...
                                <div class="row" style="margin: 0 auto;">
                                    <asp:HyperLink runat="server" NavigateUrl="~/AdminChangePassword.aspx" CssClass="forgetPass">Forget Password</asp:HyperLink>
                                </div>
                                <div class="row" style="margin: 0 auto;">
                                    <asp:Button runat="server" ID="loginBtn" OnClick="loginBtn_Click" Text="Login" CssClass="loginbtn"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    Copyright Reserved © 2023 Llama Cinemas All Rights Reserved.</div>
            </div>
        </form>
    </body>
